...
// Returns the private 'App\Repository\PatientsRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\PatientsRepository.php';

return $this->privates['App\\Repository\\PatientsRepository'] = new \App\Repository\PatientsRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
