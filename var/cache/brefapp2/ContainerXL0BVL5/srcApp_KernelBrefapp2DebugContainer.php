 ...
 */
class srcApp_KernelBrefapp2DebugContainer extends Container
{
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'debug.container.dump': $value = ($this->targetDirs[0].'/srcApp_KernelBrefapp2DebugContainer.xml'); break;
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.container_class' => 'srcApp_KernelBrefapp2DebugContainer',
            ...
            'router.cache_class_prefix' => 'srcApp_KernelBrefapp2DebugContainer',
