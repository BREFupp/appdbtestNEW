...
// Returns the private 'App\Repository\ActusRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\ActusRepository.php';

return $this->privates['App\\Repository\\ActusRepository'] = new \App\Repository\ActusRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
